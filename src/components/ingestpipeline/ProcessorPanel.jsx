import { EuiFlexGroup, EuiFlexItem, EuiPanel, EuiText, EuiButtonIcon, EuiSpacer } from '@elastic/eui';
...
const ProcessorPanel = ({ name, tag, idx }) => {
  ...
  const removePipelineItem = useGlobalState((state) => state.removePipelineItem);
